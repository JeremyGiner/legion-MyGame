...
//	Constructor
	...
	public function new( ?seed :Int, ?octaves, ?falloff :Float ) {
...
//	Accessor
	...
	public function get( 
		iWith :Int, iHeight :Int , 
		_x :Float, _y :Float, _z :Float 
	) :Array<Array<Float>> {
		var aOutput = new Array<Array<Float>>();
		var baseX :Float;
...
//	Sub-routine
	...
	private function octFreqPers( fPersistence :Float ) {
