...
import mygame.game.ability.GuidanceProjectile;
...
class Projectile extends Entity {
	...
	public function new( oGame :MyGame, x :Int, y :Int, oTarget :Dynamic ) {
		...
		//_ability_add( new Mobility( cast this, 1000 ) );
		/*if( Std.is(oTarget,Entity) )
			_ability_add( new GuidanceMissile( this, oTarget.identity_get() ) );
		else if( Std.is(oTarget,Vector2i) )
			_ability_add( new GuidanceProjectile( this, oTarget ) );*/
		//oGame.guidance.add( this, new GuidanceProjectile( this, oTarget ));
	}
