...
class websocket_php_SocketLocal extends websocket_php_Socket {
	...
	static function create() {
		return new websocket_php_SocketLocal(socket_create( AF_INET, SOCK_STREAM, SOL_TCP ));
	}
	function __toString() { return 'websocket.php.SocketLocal'; }
}
